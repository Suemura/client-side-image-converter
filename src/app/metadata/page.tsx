...
export default function MetadataPage() {
  ...
  const [selectedFileForModal, setSelectedFileForModal] = useState<File | null>(
    null,
  );
  ...
  const getProcessingMethodBadge = (file: File) => {
    ...
    const badgeClass = isJpeg
      ? styles.processingMethodSelective
      : styles.processingMethodAll;
    const textKey = isJpeg
      ? "metadata.processingMethod.selective"
      : "metadata.processingMethod.allRemoval";
                ...
                <div className={styles.imagesGrid}>
                  {selectedFiles.map((file, index) => (
                    ...
                    >
                      ...
                      <p className={styles.imageFileName}>{file.name}</p>
                  ...
                  <>
                    ...
                    {analysis.privacyRiskTags.size > 0 && (
                      <div style={{ marginBottom: "24px" }}>
                        ...
                        >
                          {t("metadata.privacyRiskTags")} (
                          {analysis.privacyRiskTags.size})
                        </h3>
                        <div
                        ...
                        >
                          {Array.from(analysis.privacyRiskTags).map((tag) => (
                            <div key={tag} className={styles.tagItem}>
                              ...
                              />
                              <span
                                className={`${styles.tagName} ${styles.privacyTag}`}
                              >
                                {tag}
                              </span>
